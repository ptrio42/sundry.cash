...
- `src/tests/` — Jest + supertest, 319 cases across 18 files (plus `env.ts` / `paths.ts` /
...
2. `npm run test` passes; add/extend tests for behavior changes (319 backend + 662 frontend cases;
