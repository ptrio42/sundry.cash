...
// Re-exported for backwards compatibility: the keyword categorizer now lives in
// the shared services/categorize module (also used by the receipt scanner).
export { autoCategorizeByKeywords } from '../services/categorize';
